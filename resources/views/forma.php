        ...
        <div class="col-md-8">
            <form class="form-horizontal" role="form">
                <div id="forma1">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="katedra">Katedra:</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="predmet">Predmet:</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="profesor">Profesor:</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="godina_studija">Godina studija:</label>
                        <div class="col-md-9">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2" for="varijacije">Varijacije zvuka:</label>
                    <div class="col-md-9">
                        <textarea rows="4" cols="5" class="form-control" id="varijacije"></textarea>
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-2" for="napomene_2">Napomene:</label>
                    <div class="col-md-9">
                        <textarea rows="4" cols="5" class="form-control" id="napomene_2"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                        <button type="submit" class="btn btn-default" id="forma_potvrdi">Potvrdi</button>
                    </div>
                </div>
