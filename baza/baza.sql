...
CREATE TABLE IF NOT EXISTS `mydb`.`Tehnicka_specifikacija` (
  `Film_id_filma` INT NOT NULL,
  `osnovni_format` VARCHAR(5) NULL,
  `filmski_format` VARCHAR(5) NULL,
  `video_format` VARCHAR(5) NULL,
  `tel_standard` VARCHAR(5) NULL,
  `analiza_slike` VARCHAR(5) NULL,
  `format_slike` VARCHAR(5) NULL,
  `br_sl_sek` VARCHAR(5) NULL,
  `video_nosac` VARCHAR(5) NULL,
  `vrsta_fajla` VARCHAR(5) NULL,
  `zvuk` VARCHAR(5) NULL,
  `broj_kanala` VARCHAR(5) NULL,
  `redukcija_suma` VARCHAR(5) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Karton_prilog` (
  ...
  `Film_id_filma` INT NOT NULL,
  `tip_priloga` VARCHAR(5) NOT NULL,
